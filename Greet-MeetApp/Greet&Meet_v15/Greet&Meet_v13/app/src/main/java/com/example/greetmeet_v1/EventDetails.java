...
public class EventDetails extends AppCompatActivity {
    EditText eventName,eventDesc,eventHost,eventLocation,eventDate,textView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Listofusers.add("test1");
        Listofusers.add("test2");
        Listofusers.add("test3");
        Listofusers.add("test4");
